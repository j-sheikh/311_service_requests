...
"""**creating new coloumns with the weekday when complain was created and closed**"""
...
Before working with Duration Ticket though,we need to check if the values we would get make sense.
"""
...
More information,why there are more on a Friday than on a sunday later in the graphical part
# **Graphical**
...
"""*If u reported a complaint about Building Condition,the average waiting time untill the report gets closed is 1385.5 minutes*
...
*Manhattan has 1.63 citiziens*,
*Bronx has 1.47 citiziens*,
*Queens has 2.36 citiziens*,
*Brooklyn has 2.53 citiziens*
...
"""* We can see during the workdays (Mo-Fr) the highest complaints are about Illegal Parking, which makes sense because more people driving inside the city to work,shop and so on.*
*On Friday,our highst day with complaints,heat/hot water problems are on top.Which can be correlated with the citiziens coming home for the weekend.We also have a increase in Noise - Residential,which is the top complain on Saturday and Sunday. Which makes sense,because on weekends,most citiziens are home and are more sensitive to noise(want to relax),also on weekends parties and loud music are more likely.*
...
"""* Like i thought,Loud Music/Party is the reason for the hight Noise complaints*"""
